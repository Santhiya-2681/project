...
const Tabs = ({activeTabName,onClickTab}) => {
    ...
    const renderTabTitle = (tabTitle,isActivate,icon,id)=>(
        <div onClick={()=>onClickTab(tabTitle)} id={id} className={`tab-item ${isActivate && 'tab-border'}`}>
             <i className={icon}></i>
             <p>{tabTitle}</p>
        </div>
    )
  return (
    <>
            ...
            <div className='container'>
                <div 
                 ...
                 <div className='tab-1-content-inner'>
                    <div>
                        <p className='text-lg'>
                            If you decise Netflix isn't for you - no problem. No
                            commitment. Cancel online anytime
                        </p>
                        
                        <button className='front-btn text-[25px] font-bold' >Get Started</button>
                            {/* Watch Free For 30 days */}
                       
                    </div>
                    <img src='https://i.ibb.co/J2xDJV7/tab-content-1.png' alt='' className='cancel-img'/>
                 </div>
            ...
            <div className='container'>
                <div id='tab-2-content' className={`tab-content-item ${activeTabName === WATCH_ANYWHERE && "show"}`}>
                    <div className='tab-2-content-top'>
                        <p className='text-lg'>Watch TV shows and movies anytime, anywhere - personalized for
                        you.
                        </p>
                        <button className='front-btn text-[25px] font-bold' >Get Started</button>
                    </div>
       ...
       {activeTabName === PICK_YOUR_PRICE && (
        <section className='tab-content'>
            <div className='container'>
                <div id='tab-3-content-item' className={`tab-content-item ${activeTabName === PICK_YOUR_PRICE && 'show'}`}>
                    ...
                    <table className='table'>
                        ...
                        <tbody>
                            <tr>
                                <td>Monthly price after free month ends on 7/12/2023 </td>
                                <td>$6.99</td>
                                <td>$11.99</td>
                                <td>$15.99</td>
                            </tr>
